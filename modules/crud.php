...
class Database {
    ...
    private $server = "sqlsrv:Server=127.0.0.1;Database=donnees";
...
//    private $options = array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC,);
    ...
    public static function select($table, $rows = '*', $join = null, $where = null, $order = null, $limit = null) {
    ...
    public static function update($table, $params = array(), $where) {
        // Check to see if table exists
        if ($this->tableExists($table)) {
